...
--Fetching orders where customer's city does not match salesman's
...
WHERE Customer.city <> Salesman.city; Salesman. Salesman_id

--Fetching orders with customer's city does not match salesman's
...
SELECT *
FROM Customer
JOIN Orders ON Customer.customer_id = Orders.customer_id WHERE Orders.ord_date = '2012-10-05';